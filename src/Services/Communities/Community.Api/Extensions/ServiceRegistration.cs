...
public static class ServiceRegistration
{
    public static IServiceCollection AddApiServices(this IServiceCollection services, IConfiguration configuration)
    {
        services
            ...
            {
                // Accept/emit enum names (e.g. "Visible", "Hidden") rather than
                // ordinals, so request/response contracts stay business-readable
                // (api-guidelines.md sections 10-11).
        ...
        services
            ...
            .AddJwtBearer(options =>
            {
                ...
                // Application/Infrastructure layers can read them by their registered names.
