namespace Moderation.Application.Options;

/// <summary>
/// Binds the <c>GcpSettings:AuthSettings</c> configuration section so this
/// service can validate access tokens issued by Authentication.Api, per
/// auth-guidelines.md section 2. The signing key must never be a committed
