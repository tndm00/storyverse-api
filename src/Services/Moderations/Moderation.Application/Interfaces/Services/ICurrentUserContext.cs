namespace Moderation.Application.Interfaces.Services;
...
/// service's <c>ICurrentAuthorContext</c>; the Moderation service only needs the
/// raw user id (from the <c>sub</c> claim) for reporter/moderator attribution.
/// </summary>
